...
function onCreate()
         makeLuaSprite('win', 'achievements/humilliation', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'Humilliation', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Congratulations you humiliated BF', 200, 120, 40) -- change your description text
...
function onEndSong()
	 ...
	 runTimer('gg', 7, 1) -- 5 is 5 second before it ends song
